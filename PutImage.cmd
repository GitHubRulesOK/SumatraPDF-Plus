...
class Program
{
    					// ALTER THESE TO YOUR OWN FILE LOCATIONS
...
public class ImageForm : Form
{
    ...
    public ImageForm()
    {
        this.Width = 460; this.Height = 225; this.TopMost = true; this.FormBorderStyle = FormBorderStyle.None;
    ...
    dragBar = new Panel();
    dragBar.Left = 0; dragBar.Top = 0; dragBar.Width = this.Width; dragBar.Height = 30; dragBar.BackColor = Color.FromArgb(50,50,50);
    ...
    titleLabel.AutoSize = true; titleLabel.Left = 8; titleLabel.Top = 4;
    dragBar.Controls.Add(titleLabel);
    // add X button more code than its real worth !
    ...
    dragBar.Controls.Add(btnX);
        ...
        chkOpen = new CheckBox(); chkOpen.Left = 360; chkOpen.Top = y + 3; chkOpen.Width = 100; chkOpen.Text = "Try Open";
        chkOpen.Checked = true;   // default ON
    ...
    private void OnPut(object sender, EventArgs e)
    {
        ...
        armed = true;
        dragBar.BackColor = Color.FromArgb(120, 80, 20);   // amber-ish
        titleLabel.Text = "ARMED - Image will be applied @ click onto the PDF in view";
    }
    ...
    private void RunHiddenCommand(string exePath, string arguments, string workingDir)
    {
        try
        {
            ...
            // Debugging needs a console otherwise this is in effect hidden
            Console.WriteLine("=== REAL PROCESS CALL ===");
