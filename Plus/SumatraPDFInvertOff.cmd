@echo off & Title SumatraPDF Invert Off Version 2026-08-31-01
goto MAIN
...
class InvertOn {
    static void Main(string[] args) {
        ...
        for (int i = 0; i < lines.Length; i++) {
            if (lines[i].StartsWith("\tInvertColors = true")) {
                lines[i] = "\tInvertColors = false"; // Example: switch InvertColors = true to false
            }
        }
