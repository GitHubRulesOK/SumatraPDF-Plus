...
By default it will check the last ting on command line is a dropped file or a named fill from a shortcut. The templacte can be any cmd name it just one of my several DoDrop.cmd templates.  
